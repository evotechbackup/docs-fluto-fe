  ...
  // Getting Started Section
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          ": Communicate via chat, comments, and notifications within tasks or modules.",
      },
      {
        title: "Analytics & Reporting",
        description:
          ": Generate insightful dashboards, reports, and KPIs to monitor performance.",
      },
      {
        title: "Mobile Access",
        description:
          ": Stay connected with mobile apps that provide full functionality on the go.",
      },
      {
